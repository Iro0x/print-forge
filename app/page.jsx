...
export default function Home() {
  ...
  const handleTrack = (e) => {
    e.preventDefault()
    if (trackId.trim()) router.push(`/sledzenie?id=${encodeURIComponent(trackId.trim())}`)
  }
    ...
    <>
      ...
      <section className={styles.hero}>
        ...
        <div className={styles.heroRight}>
          <div className={styles.heroVisual}>
            ...
            <div className={styles.centerIcon}><Image src="/logomark.svg" width={100} height={100} alt="Print-Forge logomark" style={{ width: "auto", height: "auto" }} /></div>
          </div>
        </div>
      </section>
      ...
      <section className={styles.process}>
        ...
        <div className={styles.processSteps}>
          {[
            ...
            { num: '02', icon: '💬', title: 'Wycena', desc: 'W ciągu kilku godzin przesyłamy wycenę. Bez ukrytych opłat.' },
      ...
      <section className={styles.trackSection}>
        <div className={styles.trackLeft}>
          <div className={styles.sectionTag}>// Twoje zamówienie</div>
          <h2>Śledź status zamówienia</h2>
          <p>Masz już złożone zamówienie? Wpisz jego ID aby sprawdzić aktualny status — bez logowania.</p>
        </div>
        <div className={styles.trackRight}>
          <form className={styles.trackForm} onSubmit={handleTrack}>
            ...
            />
            <button type="submit" className={styles.trackBtn}>Sprawdź →</button>
          </form>
          <p className={styles.trackHint}>ID znajdziesz w e-mailu potwierdzającym lub w linku do wyceny.</p>
        </div>
      </section>
