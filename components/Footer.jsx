    ...
    <footer style={{ background: 'var(--bg)', borderTop: '1px solid var(--border)' }}>
      ...
      <div className="footer-inner">
        <div className="footer-grid">
          <div>
            <Link href="/" style={{ fontFamily: "'Bebas Neue', sans-serif", fontSize: '1.9rem', letterSpacing: '0.05em', display: 'flex', alignItems: 'center', gap: '0.6rem' }}>
          ...
          {[
            ...
            { title: 'Informacje', links: [{ href: '/faq', label: 'FAQ' }, { href: '/regulamin', label: 'Regulamin' }, { href: '/polityka-prywatnosci', label: 'Polityka prywatności' }] },
            { title: 'Kontakt', links: [{ href: 'mailto:hello@print-forge.pl', label: 'hello@print-forge.pl' }, { href: 'tel:+48123456789'}] },
          ].map(col => (
            <div key={col.title}>
